...
Revisión de NAs: Se revisaron los NA en nivel_educativo, que corresponden principalmente a menores de 5 años, y se mantuvieron sin cambios junto con las variables de consume_azucar y frecuencia_azucar. Los NA en ingreso_pc se imputaron con la mediana por municipio
...
De la base df_final se obtiene la base df_analisis, filtrada para adultos mayores de 18 años. Esta base contiene 172.538 observaciones, con 20 variables de distintos tipos: numéricas, factores y caracteres. Incluye identificadores como directorio, secuencia_p y orden.
```{r}
#//////// Se revisa la base 
df_analisis %>% 
  summarise(across(
