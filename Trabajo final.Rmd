...
# Se crea la variable de grupo edad
df_grafico_4cat <- df_grafico_4cat %>%
  mutate(
...
# 3. Visualización 
grafico2 <- ggplot(summary_4cat_ponderado, aes(x = nivel_consumo, y = prevalencia, fill = as.numeric(nivel_consumo))) +
  geom_col(alpha = 0.8) +
  ...
  labs(
    ...
    fill = "Intensidad de Consumo",
    caption = "Fuente: Cálculos propios (DANE 2023)."
  ) +
  scale_y_continuous(labels = scales::percent) +
  scale_fill_gradientn(colors = pal[c(5, 10, 20, 30)]) +  # degradado para las 4 categorías
  theme_minimal() +
  theme(
...
# Variables Categóricas (Pocas opciones: Hombre/Mujer, Sí/No, Niveles)
...
# Variables Numéricas (Rango amplio: Edad, Dinero)
vars_numericas <- list(
