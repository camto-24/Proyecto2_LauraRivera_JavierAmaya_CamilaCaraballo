...
Existe una asociación positiva entre la frecuencia de consumo de bebidas azucaradas (X) y la prevalencia de diagnóstico de enfermedades crónicas (Y).

la variable se llama P1930
...
ruta <- "C:\\1. MECA\\2025\\EXPLORACIÓN Y VISUALIZACIÓN DE DATOS- Miguel Andres Garzón\\Datos_proyecto2\\Salud.dta"
salud <- read_dta(ruta)
