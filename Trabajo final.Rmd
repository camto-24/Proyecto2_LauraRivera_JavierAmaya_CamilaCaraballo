...
variables: enfermedad cronica, intensidad de consumo (agrupado y detallado), edad y grupo eatrio, 

tabla 


Categóricas: bar plots y la tabla correspondiente (medidas absolutas y relativas; ponderadas y sin ponderar)

Numérica: Edad: 
   grafico de densidad ponderado y sin ponderar
   ponderado: media, DS, mediana, RIQ, Min-Max
